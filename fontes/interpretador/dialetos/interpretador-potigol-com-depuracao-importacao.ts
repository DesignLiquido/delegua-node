...
/**
 * Estende o `InterpretadorPotigolComDepuracao` com suporte a operações de sistema
 * de arquivos (`Arquivo.leia`, `Arquivo.salve`) e acesso à web (`URL(caminho).conteudo`,
 * `.erro`).
 */
